...
<body>
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                              <a href="shopcart/index.html">Manga</a>
                              <a href="shopcart/index.html">Oversized Tees</a>
                              <a href="shopcart/index.html">Winter wears</a>
                              <a href="shopcart/index.html">cosplay</a>
                            </div>
                          </div>
                    </li>
                    <li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                              <a href="shopcart/index.html">Naruto</a>
                              <a href="shopcart/index.html">One Piece</a>
                              <a href="shopcart/index.html">attack on titan</a>
                              <a href="shopcart/index.html">Jujutsu kaisen</a>
                            </div>
                          </div>
                    </li>
                    <li>
    ...
    <div class="items">
        <a href="shopcart/index.html"><img src="banneroversize.webp" alt="tee"></a>
        
    </div>
    <div class="items">
        <a href="shopcart/index.html"><img src="banner_scratch_it.webp" alt="scract"></a>
        
    </div>
    <div class="items">
        <a href="shopcart/index.html"><img src="banner_manga.webp" alt="manga"></a>
        
    </div>
    <div class="items">
        <a href="shopcart/index.html"><img src="pochita_banner_compressed.webp" alt="poc"></a>
        
    </div>
        
    <div class="items">
        <a href="shopcart/index.html"><img src="wintercoming.webp" alt="poc"></a>
